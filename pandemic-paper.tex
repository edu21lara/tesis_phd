...
%   \footnotesize
%     \input{figs_tabs/workday_salidas_modahome5_correc.frac.exit.lock/PanelModels_MobRisk_moda.home5_FullInteraction_NominalData_v4}
% \end{table}
...
\begin{table}[htbp] \centering
  ...
  \label{tab:results_mob} 
  \footnotesize
    \input{imagenes/figs_tabs_pandemic/LockdownOnMobility/PanelModels_LogFrackOut_LogMobRisk_moda.home5_FullInteraction_NominalData_v5_RobustError}
\end{table}
...
\begin{table}[!htbp] 
    ...
    \input{imagenes/figs_tabs_pandemic/mobility_Rt/rev_logRt_lag_v2}
    \label{tab:main_mobRt_results1} 
\end{table}

 %\begin{table}[!htbp] 
  %   \centering
  %   \input{figs_tabs/mobility_Rt/rev_logRt_lag_adj}
    %  \label{tab:main_mobRt_results1} 
 %\end{table}
